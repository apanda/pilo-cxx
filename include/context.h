...
class Context {
   ...
   private:
    ...
    struct TaskCompare {
        inline bool operator()(const std::tuple<Time, Task>& t1, const std::tuple<Time, Task>& t2) const {
            Time time1, time2;
    ...
    typedef boost::heap::fibonacci_heap<std::tuple<Time, Task>, boost::heap::compare<TaskCompare>> Queue;
